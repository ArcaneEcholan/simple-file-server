    ...
    <div style="margin: 50px 40px">
        ...
        <div class="flex mgb20" style="width: 50%">
            ...
            <div>
                <el-button
                    :disabled="scanning"
                    @click="select_dir_dialog.open()"
                >select dir</el-button>
            </div>
        ...
        <div>
                ...
                <el-card class="box-card">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex">
                            ...
                            <div>
                                <span>{{ curdir_info.numberOfFiles }}</span>
                            </div>
                        </div>
            ...
            <div>
                <el-card>
                    <div>
                        <el-button @click="goback(curdir_info.path)">
        ...
        >
            <template #default="scope">
                ...
                <div>
                    <div>
                        <el-button @click="pick_cur_dir(scope.data.cur_path)" />
                    </div>
                    <div>
                    ...
                    <el-table-view :model="select_dir_cur_dir_file_list">
                        <template slot-scope="scope">
                            ...
                            <div v-if="scope.col.prop == undefined">
                                <span
                                    class="underline pointer"
                                    @click="select_dir_pick(scope.row['id'])"
                                >选择</span>
                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            select_dir_cur_dir_file_list: new OopElTableModel('权限列表', {
                ...
                do_fetch_data(data) {
                    disk_api
                        .filelist({ path: vue.select_dir_dialog.data.cur_path })
                        .then((resp) => {
                            let counter = 0
                            if (resp.data) {
    ...
    methods: {
        ...
        initWebsocket() {
            if (typeof WebSocket === 'undefined') {
                ...
                this.socket = new WebSocket(
                    `ws://${process.env.VUE_APP_HOST}:${process.env.VUE_APP_POST}/wsserver`
                )
                // 监听socket连接
        ...
        select_dir_pick(id) {
            ...
            const pick_dir = cur_path_dirs.find((dir) => {
                return dir.id === id
            })
        ...
        select_dir_back() {
            ...
            const lastSplash =
                vue.select_dir_dialog.data.cur_path.lastIndexOf('/')
            if (lastSplash === -1) {
                throw new Error('path error')
            }

            let parent_path = vue.select_dir_dialog.data.cur_path.substring(
                0,
                lastSplash
            )
